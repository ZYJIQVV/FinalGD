...
from gd.cfg import TASK2DATA, get_cfg, get_save_dir
from gd.hub.utils import HUB_WEB_ROOT
from gd.nn.tasks import attempt_load_one_weight, guess_model_task, nn, yaml_model_load
from gd.utils import (
    ARGV,
    ASSETS,
    DEFAULT_CFG_DICT,
    LOGGER,
...
class Model(nn.Module):
    ...
    def __call__(
        ...
        **kwargs,
        ...
        Returns:
            (List[gd.engine.results.Results]): A list of prediction results, encapsulated in the Results class.
        """
    ...
    def _get_hub_session(model: str):
        ...
        from gd.hub.session import HUBTrainingSession
    ...
    def reset_weights(self) -> "Model":
        ...
        Returns:
            self (gd.engine.model.Model): The instance of the class with reset weights.
    ...
    def load(self, weights: Union[str, Path] = "yolov8n.pt") -> "Model":
        ...
        Returns:
            self (gd.engine.model.Model): The instance of the class with loaded weights.
    ...
    def predict(
        ...
        **kwargs,
        ...
        is_cli = (ARGV[0].endswith("yolo") or ARGV[0].endswith("gd")) and any(
    ...
    def track(
        ...
        **kwargs,
        ...
        Returns:
            (List[gd.engine.results.Results]): A list of tracking results, encapsulated in the Results class.

        Raises:
            AttributeError: If the predictor does not have registered trackers.
        """
        if not hasattr(self.predictor, "trackers"):
            from gd.trackers import register_tracker
    ...
    def benchmark(
        ...
        **kwargs,
        ...
        It uses the 'benchmark' function from the gd.utils.benchmarks module. The benchmarking is configured
        ...
        """
        self._check_is_pytorch_model()
        from gd.utils.benchmarks import benchmark
    ...
    def tune(
        ...
        **kwargs,
        ...
        When Ray Tune is enabled, it leverages the 'run_ray_tune' function from the gd.utils.tuner module.
        ...
        self._check_is_pytorch_model()
        if use_ray:
            from gd.utils.tuner import run_ray_tune
    ...
    def names(self) -> list:
        ...
        using the 'check_class_names' function from the gd.nn.autobackend module.

        Returns:
            (list | None): The class names of the model if available, otherwise None.
        """
        from gd.nn.autobackend import check_class_names
