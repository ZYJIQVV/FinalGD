...
Usage:
    from gd.utils.benchmarks import ProfileModels, benchmark
...
from gd import YOLO, YOLOWorld
from gd.cfg import TASK2DATA, TASK2METRIC
from gd.engine.exporter import export_formats
from gd.utils import ARM64, ASSETS, IS_JETSON, IS_RASPBERRYPI, LINUX, LOGGER, MACOS, TQDM, WEIGHTS_DIR
from gd.utils.checks import IS_PYTHON_3_12, check_requirements, check_yolo
from gd.utils.files import file_size
...
class ProfileModels:
    ...
    Example:
        ```python
        from gd.utils.benchmarks import ProfileModels
